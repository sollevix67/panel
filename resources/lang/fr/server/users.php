...
return [
    'permissions' => [
        ...
        'control_kill' => 'Permet à l\'utilisateur de forcer l\'arrêt de  l\'instance de serveur.',
        ...
        'database_update' => 'Autorise un utilisateur à apporter des modifications à une base de données. Si l\'utilisateur ne dispose pas de l\'autorisation «Afficher le mot de passe», il ne pourra pas non plus modifier le mot de passe.',
        'database_delete' => 'Autorise un utilisateur à supprimer la base de données d\'une instance.',
        'database_view_password' => 'Autorise un utilisateur à afficher un mot de passe de base de données dans le système.',
        'schedule_create' => 'Permet à un utilisateur de créer une nouvelle planification pour le serveur (tâche cron).',
        'schedule_read' => 'Autorise un utilisateur à afficher les planifications d\'un serveur.',
